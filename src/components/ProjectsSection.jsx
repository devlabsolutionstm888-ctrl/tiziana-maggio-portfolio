      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
        ...
        <div className="group bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300">
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-6 border-t border-gray-100 dark:border-gray-800">
            ...
            <a href="https://drive.google.com/file/d/1XgJ9XhW_V5oXqVzCg5h1qJv8pL_sK4w9/preview?usp=drive_link" target="_blank" rel="noopener noreferrer" className="flex-1 bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 text-gray-800 dark:text-gray-200 text-center font-bold py-3 px-6 rounded-xl transition">
              {section.details || "Dettagli"}
            </a>
          </div>
        </div>

        {/* Progetto 23: Domus Omnia Italia */}
        <div className="group bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300">
          <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">Domus Omnia Italia</h3>
          <p className="text-gray-600 dark:text-gray-300 text-base mb-8 leading-relaxed">
            Piattaforma web immobiliare e gestionale sviluppata per il mercato italiano, focalizzata su annunci di prestigio, architetture moderne e un'esperienza utente fluida e professionale.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 pt-6 border-t border-gray-100 dark:border-gray-800">
            ...
            <a href="https://drive.google.com/file/d/1olKjT24dEIzdd0f9VTgKDVJ-gbfPrTWz/preview?usp=drive_link" target="_blank" rel="noopener noreferrer" className="flex-1 bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 text-gray-800 dark:text-gray-200 text-center font-bold py-3 px-6 rounded-xl transition">
              {section.details || "Dettagli"}
            </a>
          </div>
        </div>
